...
function Form1() {
  ...
  const [formData, setFormData] = useState({
    ...
    mobile: loggedUser.mobile || prefilledData.mobile || prefilledData.phone || "",
  ...
  const handleSubmit = async (e) => {
    ...
    if (!trimmedName || !formData.classGrade || !formData.exam) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-20 flex justify-center px-4 py-12">
        <div className="w-full max-w-lg bg-white/95 backdrop-blur-md rounded-2xl border border-white/30 p-8 mt-10 mb-20 shadow-xl shadow-black/50">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full py-3 rounded-lg font-semibold text-white transition-all cursor-pointer ${loading
                  ? "bg-gray-400 cursor-not-allowed"
                  : "bg-brandColorThree hover:bg-brandColorFour"
                }`}
            >
